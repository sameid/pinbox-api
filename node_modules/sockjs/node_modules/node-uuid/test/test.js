...
function log(msg) {_log(msg, 'log');***REMOVED***
function warn(msg) {_log(msg, 'warn');***REMOVED***
function error(msg) {_log(msg, 'error');***REMOVED***
...
var UUID_FORMAT = {
  v1: /[0-9a-f]{8***REMOVED***-[0-9a-f]{4***REMOVED***-1[0-9a-f]{3***REMOVED***-[89ab][0-9a-f]{3***REMOVED***-[0-9a-f]{12***REMOVED***/i,
  v4: /[0-9a-f]{8***REMOVED***-[0-9a-f]{4***REMOVED***-4[0-9a-f]{3***REMOVED***-[89ab][0-9a-f]{3***REMOVED***-[0-9a-f]{12***REMOVED***/i
***REMOVED***;
...
for (var version in generators) {
  ...
  if (version == 'v4') {
    ['mathRNG', 'whatwgRNG', 'nodeRNG'].forEach(function(rng) {
      if (uuid[rng]) {
        var options = {rng: uuid[rng]***REMOVED***;
