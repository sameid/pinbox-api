  ...
  App = (function(_super) {
    ...
    ***REMOVED***;
    ...
    App.prototype.h_sid = function(req, res, data) {
      ...
      ***REMOVED*** else if (this.options.jsessionid && res.setHeader) {
  ...
  Server = (function(_super) {
    ...
    ***REMOVED***
    ...
    Server.prototype.listener = function(handler_options) {
      var options,
        _this = this;
      options = utils.objectExtend({***REMOVED***, this.options);
